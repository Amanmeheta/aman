<?php 
/** 
* The base configurations of the Aman. 
* 
* This file has the following configurations: MySQL settings, Table Prefix, 
* Secret Keys, Aman Language, and ABSPATH. You can find more information 
...
/** The name of the database for Aman */ 
define('DB_NAME', 'Aman'); 
 ...
 * You can generate these using the {@link https://api.wordpress.org/secret-key/1.1/salt/ Aman.org secret-key service} 
...
/** 
 * Aman Localized Language, defaults to English. 
 * 
 * Change this to localize Aman. A corresponding MO file for the chosen 
...
/** 
 * For developers: Aman debugging mode. 
 * 
...
/** Absolute path to the Aman directory. */ 
if ( !defined('ABSPATH') ) 
	define('ABSPATH', dirname(__FILE__) . '/'); 
 
/** Sets up Aman vars and included files. */ 
